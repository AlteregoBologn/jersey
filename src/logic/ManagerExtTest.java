...
public class ManagerExtTest
{
	...
	public void testSalvaPersonaCompleta()
	{
		...
		if (ret.isEmpty())
			throw new RuntimeException("L'arrayList delle Persone Complete � vuoto");
		...
		System.out.println("La persona completa " +pc+ "� uguale alla persona completa dell'arraylist " +ret);
	}
